...
public class StonePulsButton : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    #region//メソッド
    public void ChangeStone() //現在の石に[100]加算して、石のテキストに現在の石の数値に更新するメソッド
    {
        GameManager.GManager.AbbStone(100); //現在の石に引数[100]を加算するメソッド
    }
    #endregion
    ...
    {
        _onClickCallback = ChangeStone; //[_onClickCallback]変数に[ChangeStone]メソッドを代入する
    }
