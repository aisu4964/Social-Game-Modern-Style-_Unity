...
public class PanelInside : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        popup.SetActive(false); //指定したゲームオブジェクトをアクティブ(表示・有効化)にする
    }
}
