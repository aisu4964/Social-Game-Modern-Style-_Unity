...
public class StaminaPulsButton : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    #region//メソッド
    public void ChangeStamina() //現在のスタミナを[-10]減少させて、スタミナのテキストに現在のスタミナと現在のスタミナ最大値を更新するメソッド
    {
        GameManager.GManager.AbbStamina(-10); //現在のスタミナに引数[-10]を減少させるメソッド
    }
    #endregion
    ...
    {
        _onClickCallback = ChangeStamina; //[_onClickCallback]変数に[ChangeExperience]メソッドを代入した
    }
